...
import AttackCorelliaNordTeam1 from './SelectionTeam/TeamNord/AttackCorelliaNordTeam1';
import DefenseCorelliaNordVague1 from './SelectionTeam/TeamNord/DefenseCorelliaNordVague1';
import DefenseCorelliaNordVague2 from './SelectionTeam/TeamNord/DefenseCorelliaNordVague2';
import AttackCorelliaNordTeam2 from './SelectionTeam/TeamNord/AttackCorelliaNordTeam2';

const AttackCorelliaNord: React.FC = () => {
          ...
          <div>
            ...
            <div className='xl:flex w-full xl:gap-20 xl:p-12'>
              <div className='flex flex-col flex-1'>
                ...
                <AttackCorelliaNordTeam1 />
                <YouTubeEmbed videoUrl="https://www.youtube.com/embed/uZxgBx1S91E?start=58" start={58} />
                <p className='text-xl md:text-3xl lg:text-5xl xl:text-3xl font-bold mt-8 lg:mt-14 lg:mb-8'>Équipes alternatives</p>
                <AttackCorelliaNordTeam2 />
                <YouTubeEmbed videoUrl="https://www.youtube.com/embed/7RSN-IlGFCc" start={0} />
              </div>
              ...
              <div className='flex flex-col flex-1'>
                ...
                <p className='text-lg md:text-xl lg:text-3xl xl:text-xl lg:mt-4 text-slate-300 italic mt-4 text-justify leading-relaxed'>
                  - Avec BT-1 et 0-0-0 nécessaires pour les pelotons, Aphra + les droïdes séparatistes devraient aussi fonctionner.
                </p>
...
export default AttackCorelliaNord;