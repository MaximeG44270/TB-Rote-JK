...
const starRequirements = [
  { stars: "1 Star", mpg: "111 718 750 MPG" },
  { stars: "2 Stars", mpg: "178 750 000 MPG" },
  { stars: "3 Stars", mpg: "238 333 333 MPG" },
];

const StarRequireCorellia: React.FC = () => {
  return (
...
export default StarRequireCorellia;