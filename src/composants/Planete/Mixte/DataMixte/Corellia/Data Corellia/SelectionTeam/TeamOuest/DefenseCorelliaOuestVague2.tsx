...
const DefenseCorelliaOuestVague2: React.FC = () => {
  const order = ["Imperial-officer", "Trooper-commando", "Stormtrooper", "Stormtrooper", "scout-trooper", "tie-pilote"];
...
export default DefenseCorelliaOuestVague2;