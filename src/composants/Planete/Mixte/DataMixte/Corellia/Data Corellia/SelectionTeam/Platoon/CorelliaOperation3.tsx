...
const CorelliaOperation3: React.FC = () => {
  const order = [
    "Tie-interceptor", "Padme", "GMY", "Ghost", "Wat",
    "Tie-interceptor", "Cls", "DR", "Paploo", "bossk",
    "boba-heritie", "Chebacca", "Rey-training", "3po-Chewie", "Clone-170"
  ];
...
export default CorelliaOperation3;