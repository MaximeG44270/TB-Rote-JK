...
const DefenseCorelliaEstVague1: React.FC = () => {
  const order = ["mob-enforcer", "Cartel-spy", "Cartel-bruiser", "Cartel-bruiser", "Cartel-saboteur"];
...
export default DefenseCorelliaEstVague1;