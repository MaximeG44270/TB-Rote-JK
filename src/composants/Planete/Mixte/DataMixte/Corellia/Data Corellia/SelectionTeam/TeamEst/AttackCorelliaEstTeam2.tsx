...
const AttackCorelliaEstTeam2: React.FC = () => {
  const order = ['Jabba', 'cad-bane', 'Greedo', 'Embo', 'Gamorrean'];

  const borderColors: Record<string, string> = {
    Jabba: 'border-yellow-400',
    'cad-bane': 'border-red-400',
    Greedo: 'border-red-400',
    Embo: 'border-red-400',
    Gamorrean: 'border-red-400',
  };
...
export default AttackCorelliaEstTeam2;