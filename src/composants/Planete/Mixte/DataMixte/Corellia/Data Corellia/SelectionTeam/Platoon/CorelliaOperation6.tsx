...
const CorelliaOperation6: React.FC = () => {
  const order = [
    "Tie-interceptor", "Mandobeskar", "Sonde-imp", "Talia", "KAM",
    "Tie-interceptor", "Palpa", "YodaHermit", "Piett", "Sion",
    "Tie-interceptor", "DR", "GK", "Sana", "Jawa-engineer"
  ];
...
export default CorelliaOperation6;