...
const AttackCorelliaOuestTeam1: React.FC = () => {
  const order = ['Nass', 'Jarjar', 'Tarpals', 'Boomadier', 'Phalanx'];

  const borderColors: Record<string, string> = {
    Nass: 'border-blue-400',
    Jarjar: 'border-blue-400',
    Tarpals: 'border-blue-400',
    Boomadier: 'border-blue-500',
    Phalanx: 'border-blue-500',
  };
...
export default AttackCorelliaOuestTeam1;