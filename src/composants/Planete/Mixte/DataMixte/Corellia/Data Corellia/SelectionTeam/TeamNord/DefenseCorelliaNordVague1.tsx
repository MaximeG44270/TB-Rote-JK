...
const DefenseCorelliaNordVague1: React.FC = () => {
  const order = ["Trooper-commando", "Stormtrooper", "tie-pilote", "Stormtrooper", "scout-trooper"];
...
export default DefenseCorelliaNordVague1;