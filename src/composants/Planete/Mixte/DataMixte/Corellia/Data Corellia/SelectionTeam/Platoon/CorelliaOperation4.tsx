...
const CorelliaOperation4: React.FC = () => {
  const order = [
    "Ben", "DR", "Leia-rebelle", "Dark-vador", "KAM",
    "DM", "BB-8", "Traya", "Navette-kylo", "Sergent-clone-1",
    "CAT", "C-3po", "Traya", "Chasseur-plo", "T3-M4"
  ];
...
export default CorelliaOperation4;