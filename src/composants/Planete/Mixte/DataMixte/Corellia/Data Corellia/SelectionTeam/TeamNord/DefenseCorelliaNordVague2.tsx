...
const DefenseCorelliaNordVague2: React.FC = () => {
  const order = ["Imperial-officer", "Trooper-commando", "Stormtrooper", "Stormtrooper", "scout-trooper"];
...
export default DefenseCorelliaNordVague2;