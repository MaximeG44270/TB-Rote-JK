...
const AttackCorelliaMissionTeam1: React.FC = () => {
  const order = ['QI-RA', 'Enfys', 'Vandor-chew', 'L3-37', 'Young-solo'];

  const borderColors: Record<string, string> = {
    'QI-RA': 'border-blue-400',
    Enfys: 'border-blue-400',
    'Vandor-chew': 'border-blue-400',
    'L3-37': 'border-blue-500',
    'Young-solo': 'border-blue-500',
  };
...
export default AttackCorelliaMissionTeam1;