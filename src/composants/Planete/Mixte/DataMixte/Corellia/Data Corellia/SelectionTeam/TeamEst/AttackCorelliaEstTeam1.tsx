...
const AttackCorelliaEstTeam1: React.FC = () => {
  const order = ['Jabba', 'skiff-lando', 'Boushh', 'boba', 'Krrsantan'];

  const borderColors: Record<string, string> = {
    Jabba: 'border-yellow-400',
    'skiff-lando': 'border-blue-400',
    Boushh: 'border-blue-400',
    boba: 'border-red-500',
    Krrsantan: 'border-red-500',
  };
...
export default AttackCorelliaEstTeam1;