...
const CorelliaOperation2: React.FC = () => {
  const order = [
    "Ben", "GMY", "Cls", "Hunter", "HanSolo",
    "DM", "C-3po", "DR", "Jolee", "Poe",
    "boba-heritie", "Cls", "Mandobeskar", "Bt-1", "Alpha"
  ];
...
export default CorelliaOperation2;