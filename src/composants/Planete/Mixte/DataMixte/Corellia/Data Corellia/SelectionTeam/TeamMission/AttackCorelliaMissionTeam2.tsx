...
const AttackCorelliaMissionTeam2: React.FC = () => {
  const order = ['QI-RA', 'Kuiil', 'ig-11', 'Dash-rendar', 'Young-solo'];

  const borderColors: Record<string, string> = {
    'QI-RA': 'border-blue-400',
    Kuiil: 'border-blue-400',
    'ig-11': 'border-blue-400',
    'Dash-rendar': 'border-blue-500',
...
export default AttackCorelliaMissionTeam2;