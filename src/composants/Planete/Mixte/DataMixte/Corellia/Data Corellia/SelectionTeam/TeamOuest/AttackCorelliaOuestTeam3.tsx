...
const AttackCorelliaOuestTeam3: React.FC = () => {
  const order = ['Finn', 'Rey-training', 'BB-8', 'R2D2', 'Rey-scavenger'];

  const borderColors: Record<string, string> = {
    Finn: 'border-blue-400',
    'Rey-training': 'border-blue-400',
    'BB-8': 'border-blue-400',
    R2D2: 'border-blue-500',
    'Rey-scavenger': 'border-blue-500',
  };
...
export default AttackCorelliaOuestTeam3;