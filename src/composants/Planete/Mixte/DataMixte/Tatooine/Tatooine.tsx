  ...
  return (
    <div className="overflow-x-hidden max-w-full">
      ...
      <div className="relative flex flex-col bg-gray-900 max-w-full overflow-hidden text-white">
        {/* ------------------------------------------- Image principale ------------------------------------------- */}
        <img 
          src="/Planet-main-mobile/Mixte/3-Tatooine.webp" 
          alt="Coruscant" 
        ...
        <p id="star-require" className="text-center text-7xl mt-8 font-bold font-poppins">Tatooine</p>
        <div className="p-4">
