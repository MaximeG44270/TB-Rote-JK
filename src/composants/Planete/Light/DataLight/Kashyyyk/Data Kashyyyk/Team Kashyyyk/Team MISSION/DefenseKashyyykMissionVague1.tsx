...
const DefenseKashyyykMissionVague1: React.FC = () => {
  const order = ["atst-driver", "Purge-trooper", "Purge-trooper", "Imperial-officer", "Stormtrooper"];
...
export default DefenseKashyyykMissionVague1;