...
const DefenseKashyyykVague2: React.FC = () => {
  const order = ["Mara", "Purge-trooper", "Purge-trooper", "Trooper-commando", "Stormtrooper", "Stormtrooper"];
...
export default DefenseKashyyykVague2;