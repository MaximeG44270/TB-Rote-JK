...
const KashyyykOperation3: React.FC = () => {
  const order = [
    "CAT", "Greef", "KAM", "Sergent-clone-1", "GK",
    "JML", "Faucon-han", "Leia-rebelle", "Ben", "GMY",
    "JML", "R2D2", "Leia-rebelle", "Razor", "skiff-lando"
  ];
...
export default KashyyykOperation3;