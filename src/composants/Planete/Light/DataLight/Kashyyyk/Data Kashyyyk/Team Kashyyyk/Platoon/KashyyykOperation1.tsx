...
const KashyyykOperation1: React.FC = () => {
  const order = [
    "CAT", "R2D2", "Teebo", "Mace-windu", "HanSolo",
    "JML", "Padme", "YodaHermit", "Razor", "C-3po",
    "GL-rey", "R2D2", "YodaHermit", "Razor", "Anakin"
  ];
...
export default KashyyykOperation1;