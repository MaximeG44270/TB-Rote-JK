...
const DefenseKashyyykFleetTeam1: React.FC = () => {
  const order = ["Executrix", "Tie-advanced", "Scythe", "Tie-fighter", "Tie-fighter", "Tie-interceptor"];
...
export default DefenseKashyyykFleetTeam1;