...
const DefenseKashyyykSudVague2: React.FC = () => {
  const order = ["Imperial-officer", "scout-trooper", "Trooper-commando", "Stormtrooper", "Stormtrooper", "tie-pilote"];
...
export default DefenseKashyyykSudVague2;