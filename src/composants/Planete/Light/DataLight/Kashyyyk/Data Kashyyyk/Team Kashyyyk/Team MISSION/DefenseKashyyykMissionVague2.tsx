...
const DefenseKashyyykMissionVague2: React.FC = () => {
  const order = ["Trooper-commando", "Stormtrooper", "atst-driver", "Purge-trooper", "Imperial-officer"];
...
export default DefenseKashyyykMissionVague2;