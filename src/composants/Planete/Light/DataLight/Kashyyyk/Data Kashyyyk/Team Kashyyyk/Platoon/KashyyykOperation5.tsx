...
const KashyyykOperation5: React.FC = () => {
  const order = [
    "Ben", "C-3po", "Rey-training", "Greef", "Logray",
    "GL-rey", "Greef", "CAT", "Padme", "Cls",
    "JML", "GMY", "Ben", "Greef", "K-2so"
  ];
...
export default KashyyykOperation5;