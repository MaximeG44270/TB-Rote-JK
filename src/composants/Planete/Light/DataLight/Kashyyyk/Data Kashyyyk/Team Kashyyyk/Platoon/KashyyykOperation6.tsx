...
const KashyyykOperation6: React.FC = () => {
  const order = [
    "Razor", "Cls", "Faucon-han", "Negociateur", "HanSolo",
    "GL-rey", "JKR", "Ben", "soldat-resistance", "Faucon-han",
    "JML", "Padme", "Ben", "eclaireur-ewok", "Phantom"
  ];
...
export default KashyyykOperation6;