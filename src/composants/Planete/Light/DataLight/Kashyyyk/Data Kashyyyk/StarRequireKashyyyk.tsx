...
const starRequirements = [
  { stars: "1 Star", mpg: "190 953 125 MPG" },
  { stars: "2 Stars", mpg: "305 525 000 MPG" },
  { stars: "3 Stars", mpg: "407 366 667 MPG" },
];

const StarRequireKashyyyk: React.FC = () => {
  return (
...
export default StarRequireKashyyyk;