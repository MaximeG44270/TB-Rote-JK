...
import AttackKashyyykEstTeam1 from './Team Kashyyyk/Team EST/AttackKashyyykEstTeam1';
...
import DefenseKashyyykVague2 from './Team Kashyyyk/Team EST/DefenseKashyyykEstVague2';

const AttackKashyyykEst: React.FC = () => {
          ...
          <div>
            ...
            <div className='xl:flex w-full xl:gap-20 xl:p-12'>
              <div className='flex flex-col flex-1'>
                ...
                <YouTubeEmbed videoUrl="https://www.youtube.com/embed/tuijX4-bWP8" start={406} />
              </div>
...
export default AttackKashyyykEst;