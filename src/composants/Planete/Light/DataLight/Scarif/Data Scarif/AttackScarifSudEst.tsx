...
import AttackScarifSudEstTeam1 from './Team Scarif/Team SUD-EST/AttackScarifSudEstTeam1';
import AttackRokSudTeam1 from '../../RingOfKafrene/Data ROK/Team ROK/Team SUD/AttackRokSudTeam1';
...
const AttackScarifSudEst: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (window.location.hash === "#attack-sud-est") {
      setIsOpen(true);
    }
  }, []);
  ...
  return (
    <div className="flex justify-center mt-4 md:mt-8 lg:mt-12">
      <div className='p-4 md:p-10 xl:p-5 border border-gray-600 bg-gray-700 text-white font-poppins text-center w-full rounded-lg md:rounded-2xl lg:rounded-3xl h-auto'>
        ...
        >
          Bataille SUD-EST {isOpen ? <ChevronUp size={32} className="ml-auto" /> : <ChevronDown size={32} className="ml-auto" />}
        </button>
        {isOpen && (
          <div>
            ...
            <div className='xl:flex w-full xl:gap-20 xl:p-12'>
              <div className='flex flex-col flex-1'>
                ...
                <AttackScarifSudEstTeam1 />
                <YouTubeEmbed videoUrl="https://www.youtube.com/embed/-RYK0T-qaDY" />
                <p className='text-xl md:text-3xl lg:text-5xl xl:text-3xl font-bold mt-8 lg:mt-14 lg:mb-8'>Équipes alternatives (hors GL)</p>
                <AttackRokSudTeam1 />
                <YouTubeEmbed videoUrl="https://www.youtube.com/embed/S6Vkp20u2mI" />
              </div>
...
export default AttackScarifSudEst;