...
const DefenseScarifNordOuestVague2: React.FC = () => {
  const order = ['Imperial-officer', 'Death-trooper', 'Death-trooper', 'Shore-trooper', 'Stormtrooper', 'Stormtrooper'];
...
export default DefenseScarifNordOuestVague2;