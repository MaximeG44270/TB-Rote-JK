...
const ScarifOperation1: React.FC = () => {
  const order = [
    "JMK", "CAT", "X-wing-dark", "GK", "Bastila-light",
    "JML", "CAT", "Poe", "Leia-rebelle", "Dash-rendar",
    "JMK", "CAT", "Police", "YodaHermit", "Raven-claw"
  ];
...
export default ScarifOperation1;