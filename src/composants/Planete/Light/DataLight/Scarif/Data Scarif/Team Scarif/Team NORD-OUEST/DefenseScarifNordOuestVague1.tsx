...
const DefenseScarifNordOuestVague1: React.FC = () => {
  const order = ['Death-trooper', 'Death-trooper', 'atst-driver', 'Shore-trooper', 'Stormtrooper'];
...
export default DefenseScarifNordOuestVague1;