...
const ScarifOperation3: React.FC = () => {
  const order = [
    "GL-rey", "Leia-rebelle", "Ben", "Padme", "Bastila-light",
    "JML", "KAM", "Razor", "Chebacca", "Dash-rendar",
    "JMK", "YodaHermit", "Razor", "GMY", "Raven-claw"
  ];
...
export default ScarifOperation3;