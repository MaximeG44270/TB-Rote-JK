...
const ScarifOperation6: React.FC = () => {
  const order = [
    "GL-rey", "HanSolo", "Razor", "Faucon-han", "Bastila-light",
    "JMK", "Leia-rebelle", "Ben", "JKR", "skiff-lando",
    "JML", "YodaHermit", "Ben", "BB-8", "Dash-rendar",
  ];
...
export default ScarifOperation6;