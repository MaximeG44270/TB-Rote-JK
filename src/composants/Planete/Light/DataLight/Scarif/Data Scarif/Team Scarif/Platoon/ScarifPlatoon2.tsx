...
const ScarifOperation2: React.FC = () => {
  const order = [
    "GL-rey", "Ben", "Mando", "Kanan", "Ima-gun",
    "GL-rey", "Razor", "Rey-scavenger", "Lobot", "Bastila-light",
    "JML", "Razor", "Dash-rendar", "Outrider", "Raven-claw"
  ];
...
export default ScarifOperation2;