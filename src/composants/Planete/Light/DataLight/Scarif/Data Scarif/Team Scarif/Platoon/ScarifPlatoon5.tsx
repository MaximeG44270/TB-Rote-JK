...
const ScarifOperation5: React.FC = () => {
  const order = [
    "JML", "HanSolo", "Ben", "Tech", "Ima-gun",
    "JML", "Logray", "Ben", "Zaalbar", "Bastila-light",
    "GL-rey", "HanSolo", "Razor", "X-wing-resistance", "skiff-lando"
  ];
...
export default ScarifOperation5;