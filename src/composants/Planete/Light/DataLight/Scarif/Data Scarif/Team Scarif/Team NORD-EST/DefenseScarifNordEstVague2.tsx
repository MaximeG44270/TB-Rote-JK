...
const DefenseScarifNordEstVague2: React.FC = () => {
  const order = ['Krennic', 'Death-trooper', 'Death-trooper', 'Shore-trooper', 'Stormtrooper', 'Stormtrooper'];
...
export default DefenseScarifNordEstVague2;