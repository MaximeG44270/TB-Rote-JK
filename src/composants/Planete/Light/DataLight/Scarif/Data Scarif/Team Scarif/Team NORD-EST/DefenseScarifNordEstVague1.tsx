...
const DefenseScarifNordEstVague1: React.FC = () => {
  const order = ['Death-trooper', 'Death-trooper', 'Sonde-imp', 'Shore-trooper', 'Stormtrooper'];
...
export default DefenseScarifNordEstVague1;