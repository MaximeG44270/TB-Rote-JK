...
const ScarifOperation4: React.FC = () => {
  const order = [
    "JML", "KAM", "L3-37", "CAT", "Bastila-light",
    "GL-rey", "YodaHermit", "Xanadu", "Razor", "Mara",
    "JMK", "KAM", "Rey-scavenger", "Ben", "Dash-rendar"
  ];
...
export default ScarifOperation4;