...
import AttackScarifNordEstTeam1 from './Team Scarif/Team NORD-EST/AttackScarifNordEstTeam1';
import DefenseScarifNordEstVague1 from './Team Scarif/Team NORD-EST/DefenseScarifNordEstVague1';
import DefenseScarifNordEstVague2 from './Team Scarif/Team NORD-EST/DefenseScarifNordEstVague2';

const AttackScarifNordEst: React.FC = () => {
  ...
  return (
    <div className="flex justify-center mt-4 md:mt-8 lg:mt-12">
      <div className='p-4 md:p-10 xl:p-5 border border-gray-600 bg-gray-700 text-white font-poppins text-center w-full rounded-lg md:rounded-2xl lg:rounded-3xl h-auto'>
        ...
        >
          Bataille NORD-EST {isOpen ? <ChevronUp size={32} className="ml-auto" /> : <ChevronDown size={32} className="ml-auto" />}
        </button>
        {isOpen && (
          <div>
            ...
            <p className='text-lg md:text-xl lg:text-3xl xl:text-xl lg:mt-4 text-slate-300 italic mt-2 leading-relaxed text-center'>
              5x Côté Lumière ou Neutre (Relique 9+), Cassian Andor, K-2SO, Pao
            </p>
            <div className='xl:flex w-full xl:gap-20 xl:p-12'>
              <div className='flex flex-col flex-1'>
                ...
                <AttackScarifNordEstTeam1 />
                <p className='text-lg md:text-xl lg:text-3xl xl:text-xl lg:mt-4 text-slate-300 italic mt-2 leading-relaxed text-center'>
                  Réussite : 1/2
                </p>
                <YouTubeEmbed videoUrl="https://www.youtube.com/embed/Nepcwo_XzYw" />
              </div>
...
export default AttackScarifNordEst;