...
import AttackLothalEstTeam1 from './Team Lothal/Team EST/AttackLothalEstTeam1';
import AttackLothalEstTeam2 from './Team Lothal/Team EST/AttackLothalEstTeam2';
import AttackLothalEstTeam3 from './Team Lothal/Team EST/AttackLothalEstTeam3';
import AttackLothalEstTeam4 from './Team Lothal/Team EST/AttackLothalEstTeam4';
import DefenseLothalVague1 from './Team Lothal/Team EST/DefenseLothalEstTeam1';
import DefenseLothalVague2 from './Team Lothal/Team EST/DefenseLothalEstTeam2';

const AttackLothalEst: React.FC = () => {
        ...
        {isOpen && (
          <div>
            ...
            <p className='text-lg md:text-xl lg:text-3xl xl:text-xl lg:mt-4 text-slate-300 italic mt-2 leading-relaxed text-center'>
              5x Côté Lumineux ou Neutre (Relique 8+)
            </p>
            <div className='xl:flex w-full xl:gap-20 xl:p-12'>
              ...
              <div className='flex flex-col flex-1'>
                ...
                <p className='text-lg md:text-xl lg:text-3xl xl:text-xl lg:mt-4 text-slate-300 italic mt-4 text-justify leading-relaxed'>
                  - Chaque fois qu'un allié utilise une capacité spéciale pendant son tour, appelez un autre allié au hasard pour assister. Chaque fois qu'un personnage attaque hors de son tour, il gagne une pile de Rébellion. À 20 piles de Rébellion, ils gagnent un bonus de 30 % d'Offense.
                </p>
                <p className='text-lg md:text-xl lg:text-3xl xl:text-xl lg:mt-4 text-slate-300 italic mt-4 text-justify leading-relaxed'>
...
export default AttackLothalEst;