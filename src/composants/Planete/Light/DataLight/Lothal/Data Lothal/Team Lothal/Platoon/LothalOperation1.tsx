...
const LothalOperation1: React.FC = () => {
  const order = [
    "JML", "YodaHermit", "Ben", "chew-veteran", "JKR",
    "JML", "Leia-rebelle", "Razor", "Zaalbar", "Dash-rendar",
    "Profundity", "HanSolo", "Razor", "Xanadu", "Y-wing"
  ];
...
export default LothalOperation1;