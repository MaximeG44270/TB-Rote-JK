...
const LothalOperation2: React.FC = () => {
  const order = [
    "Profundity", "KAM", "CAT", "Mandobeskar", "Chebacca",
    "Profundity", "YodaHermit", "CAT", "BB-8", "Zaalbar",
    "JML", "GK", "CAT", "Chebacca", "Xanadu"
  ];
...
export default LothalOperation2;