...
const LothalOperation3: React.FC = () => {
  const order = [
    "Profundity", "YodaHermit", "Razor", "Finn", "R2D2",
    "GL-rey", "KAM", "CAT", "50R-T", "Raven-claw",
    "Profundity", "YodaHermit", "Ben", "Ebon-hawk", "Nebit"
  ];
...
export default LothalOperation3;