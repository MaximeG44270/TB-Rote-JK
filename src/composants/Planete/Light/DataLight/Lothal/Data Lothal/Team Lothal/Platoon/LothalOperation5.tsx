...
const LothalOperation5: React.FC = () => {
  const order = [
    "JMK", "HanSolo", "Tech", "Padme", "JKR",
    "JMK", "Logray", "Jedi-consulaire", "GMY", "Razor",
    "Profundity", "Logray", "Bistan", "Faucon-han", "Chasseur-plo"
  ];
...
export default LothalOperation5;