...
const DefenseLothalVague2: React.FC = () => {
  const order = ["Imperial-officer", "Trooper-commando", "scout-trooper", "scout-trooper", "Stormtrooper", "Stormtrooper"];
...
export default DefenseLothalVague2;