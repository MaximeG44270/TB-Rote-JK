...
const LothalOperation6: React.FC = () => {
  const order = [
    "JML", "Leia-rebelle", "Wedge-xwing", "Sana", "Padme",
    "JML", "YodaHermit", "Echo", "secura", "Ben",
    "JML", "GK", "Wicket", "50R-T", "ohnaka"
  ];
...
export default LothalOperation6;