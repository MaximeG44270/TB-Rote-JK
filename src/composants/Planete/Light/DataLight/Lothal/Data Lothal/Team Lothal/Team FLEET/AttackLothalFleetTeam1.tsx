...
const AttackLothalFleetTeam1: React.FC = () => {
  const order = ['Negociateur', 'Eta-2', 'BTL', 'umbaran', 'Tano-fighter', 'Chasseur-plo', 'Rex-170', 'Clone-170'];
...
export default AttackLothalFleetTeam1;