...
const LothalOperation4: React.FC = () => {
  const order = [
    "Profundity", "Leia-rebelle", "Ghost", "Kyle-katarn", "Rey-training",
    "JML", "GK", "Scarif-rebelle", "Jolee", "CAT",
    "JML", "Leia-rebelle", "Outrider", "Scarif-rebelle", "Eeth"
  ];
...
export default LothalOperation4;