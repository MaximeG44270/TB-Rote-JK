...
const starRequirements = [
  { stars: "1 Star", mpg: "246 742 558 MPG" },
  { stars: "2 Stars", mpg: "419 987 333 MPG" },
  { stars: "3 Stars", mpg: "524 984 167 MPG" },
];

const StarRequireLothal: React.FC = () => {
  return (
...
export default StarRequireLothal;