  ...
  return (
    <div className="flex justify-center mt-4">
      <div className='p-4 border border-gray-600 bg-gray-700 text-white font-poppins text-center w-full max-w-md rounded-lg h-auto'>
        ...
        <p className='text-xl font-bold mt-8'>Équipes variante</p>
        ...
        <p className='text-lg text-slate-300 italic mt-4 text-justify leading-relaxed'>- Lord Vader est sans Ultimate.</p>
        ...
        <p className='text-lg text-slate-300 italic mt-4 text-justify leading-relaxed'>- Si vous utilisez JML, gardez l'ultime jusqu'à la phase 2.</p>
