  ...
  return (
    <div className="flex justify-center mt-4">
      <div className='p-4 md:p-10 border border-gray-600 bg-gray-700 text-white font-poppins text-center w-full  rounded-lg h-auto'>
        <p id="attack-est" className='text-4xl md:text-5xl font-bold mt-4'>Bataille EST</p>
        <p className='text-xl md:text-3xl font-bold mt-10'>Prérequis</p>
        <p className='text-lg md:text-xl text-slate-300 italic mt-2 text-justify leading-relaxed'>5x Jedis (Relic 5+), Mace Windu et Kit Fisto</p>
