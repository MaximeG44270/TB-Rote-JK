...
const CoruscantOperation3: React.FC = () => {
  const order = ['JKL', 'Rey-training', 'GMY', '3po-Chewie', 'YodaHermit', 'JKL', 'R2D2', 'BB-8', 'umbaran', 'Fulcrum', 'JKL', 'Padme', 'C-3po', 'Sana', 'Armorer'];
...
export default CoruscantOperation3;