...
const AttackCoruscantFleetTeam1: React.FC = () => {
  const order = ['Profundity', 'Faucon-han', 'Y-wing', 'Outrider', 'X-wing-dark', 'Phantom', 'U-wing-cassian', 'Ghost'];
...
export default AttackCoruscantFleetTeam1;