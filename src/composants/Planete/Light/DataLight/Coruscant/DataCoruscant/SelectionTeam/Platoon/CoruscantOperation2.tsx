...
const CoruscantOperation2: React.FC = () => {
  const order = ['GAS', 'BB-8', 'Chebacca', 'X-wing-resistance', 'YodaHermit', 'GAS', 'BB-8', 'Mando', 'Jyn', 'Sana', 'GAS', 'Mando', 'Chebacca', 'Sana', 'Home-one'];
...
export default CoruscantOperation2;