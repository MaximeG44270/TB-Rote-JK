...
const AttackCoruscantFleetTeam2: React.FC = () => {
  const order = ['Home-one', 'Faucon-han', 'Y-wing', 'Outrider', 'X-wing-dark', 'Phantom', 'U-wing-cassian', 'Ghost'];
...
export default AttackCoruscantFleetTeam2;