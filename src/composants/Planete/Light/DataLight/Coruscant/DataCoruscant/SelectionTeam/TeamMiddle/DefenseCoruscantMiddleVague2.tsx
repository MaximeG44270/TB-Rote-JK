...
const DefenseCoruscantMiddleVague2: React.FC = () => {
  const order = ["Clone-Chef", "Clone-arc", "Trooper-clone", "Clone-elite", "Clone-medic", "Clone-medic"];
...
export default DefenseCoruscantMiddleVague2;