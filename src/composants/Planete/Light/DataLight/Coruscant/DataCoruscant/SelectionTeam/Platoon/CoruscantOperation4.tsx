...
const CoruscantOperation4: React.FC = () => {
  const order = ['JKL', 'JKR', 'GK', 'Lobot', 'HanSolo', 'GAS', 'Mando', 'Logray', 'Chasseur-plo', 'Visas', 'GAS', 'C-3po', 'HanSolo', 'ohnaka', 'Eta-2'];
...
export default CoruscantOperation4;