          ...
          <div>
            ...
            <div className='xl:flex w-full xl:gap-20 xl:p-12'>
              <div className='flex flex-col flex-1'>
                ...
                <YouTubeEmbed videoUrl="https://www.youtube.com/embed/E03XwHmJhGY" />
              </div>
              ...
              <div className='flex flex-col flex-1'>
                ...
                <p className='text-lg md:text-xl lg:text-3xl xl:text-xl 2xl:text-2xl lg:mt-4 text-slate-300 italic mt-4 text-justify leading-relaxed'>- Vague 1 : 500 000 PG</p>
              </div>
            </div>
          </div>
        )}
