...
const missionImages: MissionImage[] = [
  { src: "/picto/mission_fleet.png", alt: "Fleet", position: "absolute top-12 left-[21rem] md:top-20 md:left-[40rem] lg:top-28 lg:left-[52rem] xl:top-20 xl:left-[56rem] 2xl:left-[64rem] w-1/12 xl:w-[4rem] xl:w-[3rem] 3xl:w-[4rem] 3xl:left-[77rem]", anchor: "attack-fleet" },
  ...
  { src: "/picto/get3.png", alt: "platoon", position: "absolute top-[16rem] w-[2rem] left-[9rem] md:top-[27rem] md:w-[4rem] md:left-[16rem] lg:top-[34rem] lg:left-[20rem] lg:w-[6rem] xl:top-[24rem] xl:left-[34rem] xl:w-[4rem] 2xl:left-[42rem] 2xl:top-[28rem] w-[3rem] md:w-[5rem] lg:w-[7rem] 3xl:w-[5rem] 3xl:left-[50rem] 3xl:top-[33rem]", anchor: "platoon" },
];
