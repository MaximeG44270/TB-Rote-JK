...
const BraccaOperation3: React.FC = () => {
  const order = [
    "Endurance", "Ben", "Echo-501", "GMY", "Ebon-hawk",
    "Greef", "Ben", "Kanan", "BB-8", "Rey-training",
    "JMK", "Ben", "Rose", "GMY", "Enfys"
  ];
...
export default BraccaOperation3;