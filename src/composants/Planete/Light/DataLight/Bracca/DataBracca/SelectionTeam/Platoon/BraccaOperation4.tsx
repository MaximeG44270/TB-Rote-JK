...
const BraccaOperation4: React.FC = () => {
  const order = [
    "3po-Chewie", "CAT", "Razor", "Bodhi", "Five",
    "Greef", "Ben", "CAT", "Ghost", "R2D2",
    "Profundity", "Razor", "Ben", "chew-veteran", "Omega"
  ];
...
export default BraccaOperation4;