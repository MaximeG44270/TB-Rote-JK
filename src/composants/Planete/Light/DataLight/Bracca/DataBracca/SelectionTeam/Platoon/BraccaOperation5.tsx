...
const BraccaOperation5: React.FC = () => {
  const order = [
    "U-wing-bistan", "Razor", "Ben", "Rey-training", "Ez-bridger",
    "Outrider", "CAT", "Razor", "Chebacca", "GMY",
    "JMK", "Razor", "Ben", "Faucon-han", "Kanan"
  ];
...
export default BraccaOperation5;