...
const DefenseBraccaMiddleVague2: React.FC = () => {
  const order = ["neuvieme-soeur", "Purge-trooper", "Purge-trooper", "Purge-trooper", "Stormtrooper"];
...
export default DefenseBraccaMiddleVague2;