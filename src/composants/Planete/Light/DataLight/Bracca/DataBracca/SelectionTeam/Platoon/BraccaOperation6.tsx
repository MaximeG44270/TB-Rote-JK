...
const BraccaOperation6: React.FC = () => {
  const order = [
    "Rex-501", "Ben", "Razor", "Cls", "Raven-claw",
    "Vandor-chew", "Razor", "CAT", "GMY", "C-3po",
    "GL-rey", "Ben", "Razor", "Padme", "Teebo"
  ];
...
export default BraccaOperation6;