...
const DefenseRokOuestVague2: React.FC = () => {
  const order = ['Imperial-officer', 'Death-trooper', 'Trooper-commando', 'Stormtrooper', 'Stormtrooper'];
...
export default DefenseRokOuestVague2;