...
const RokOperation5: React.FC = () => {
  const order = [
    "JMK", "JKL", "chew-veteran", "GMY", "50R-T",
    "Profundity", "GAS", "Baze-malbus", "R2D2", "Bodhi",
    "JML", "JKL", "soldat-hoth", "JKR", "Chebacca"
  ];
