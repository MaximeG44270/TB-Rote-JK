...
const RokOperation4: React.FC = () => {
  const order = [
    "Profundity", "JKL", "barriss", "MM", "Baze-malbus",
    "JMK", "GAS", "Negociateur", "Chopper", "Clone-chew",
    "GL-rey", "GAS", "Holdo", "soldat-resistance", "C-3po"
  ];
