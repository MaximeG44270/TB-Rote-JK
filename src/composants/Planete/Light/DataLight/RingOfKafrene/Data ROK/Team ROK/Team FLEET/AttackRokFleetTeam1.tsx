...
const AttackRokFleetTeam1: React.FC = () => {
  const order = ['Negociateur', 'Eta-2', 'BTL', 'umbaran', 'Tano-fighter', 'Chasseur-plo', 'Marauder', 'Jedi-stellaire'];
...
export default AttackRokFleetTeam1;