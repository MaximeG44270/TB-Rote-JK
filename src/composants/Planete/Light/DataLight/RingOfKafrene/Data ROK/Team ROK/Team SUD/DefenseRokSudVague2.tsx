...
const DefenseRokSudVague2: React.FC = () => {
  const order = ['Mara', 'Death-trooper', 'Trooper-commando', 'Stormtrooper', 'Stormtrooper', 'scout-trooper'];
...
export default DefenseRokSudVague2;