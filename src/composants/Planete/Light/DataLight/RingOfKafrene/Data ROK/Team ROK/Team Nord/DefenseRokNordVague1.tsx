...
const DefenseRokNordVague1: React.FC = () => {
  const order = ["mob-enforcer", "Cartel-bruiser", "Cartel-bruiser", "Cartel-spy", "Cartel-spy", "Cartel-saboteur"];
...
export default DefenseRokNordVague1;