...
const DefenseRokSudVague1: React.FC = () => {
  const order = ['Trooper-commando', 'Stormtrooper', 'Death-trooper', 'scout-trooper', 'Stormtrooper'];
...
export default DefenseRokSudVague1;