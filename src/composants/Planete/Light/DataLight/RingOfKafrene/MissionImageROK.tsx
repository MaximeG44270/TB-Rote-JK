...
const missionImages: MissionImage[] = [
  ...
  { src: "/picto/mission_platoon.png", alt: "platoon", position: "absolute  w-[3rem] md:w-[5rem] lg:w-[7rem] xl:w-[5rem] 3xl:w-[6rem] top-[17rem] left-[11rem] md:top-[29rem] md:left-[21rem] lg:top-[36rem] lg:left-[26rem] xl:left-[40rem] xl:top-[28rem] 2xl:left-[44rem] 2xl:top-[32rem] 3xl:left-[55rem] 3xl:top-[37rem]", anchor: "platoon" },
];

const MissionImagesRok: React.FC = () => {
  return (
    <>
...
export default MissionImagesRok;