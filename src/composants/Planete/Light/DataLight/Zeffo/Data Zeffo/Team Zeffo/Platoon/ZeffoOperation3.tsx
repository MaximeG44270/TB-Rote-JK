...
const ZeffoOperation3: React.FC = () => {
  const order = [
    "Ben", "JKL", "GK", "Jedi-consulaire", "Raddus",
    "JML", "C-3po", "HanSolo", "Sergent-clone-1", "Juhani",
    "JML", "GAS", "KAM", "MG100", "Kyle-katarn"
  ];
...
export default ZeffoOperation3;