...
const ZeffoOperation5: React.FC = () => {
  const order = [
    "Ben", "JKL", "Rey-training", "Jedi-consulaire", "Enfys",
    "GL-rey", "R2D2", "Cls", "Zeb", "Chirpa",
    "JML", "GAS", "KAM", "Farmboy", "Vao"
  ];
...
export default ZeffoOperation5;