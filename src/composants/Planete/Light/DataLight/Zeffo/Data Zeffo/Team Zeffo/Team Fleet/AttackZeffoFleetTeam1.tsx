...
const AttackZeffoFleetTeam1: React.FC = () => {
  const order = ['Negociateur', 'Marauder', 'BTL', 'Eta-2', 'umbaran', 'Tano-fighter', 'Chasseur-plo', 'Clone-170'];
...
export default AttackZeffoFleetTeam1;