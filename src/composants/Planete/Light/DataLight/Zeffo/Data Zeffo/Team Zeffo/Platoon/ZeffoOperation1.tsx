...
const ZeffoOperation1: React.FC = () => {
  const order = [
    "CAT", "JKL", "GK", "Kyle-katarn", "Jedi-stellaire",
    "JML", "BB-8", "HanSolo", "Chirrut", "Jolee",
    "GL-rey", "GAS", "KAM", "Jedi-consulaire", "MG100"
  ];
...
export default ZeffoOperation1;